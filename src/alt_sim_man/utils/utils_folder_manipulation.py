...
def check_dir_exist(path_dir: str):
    """
    Check if the path lead to an existing directory.
    :param path_dir: str, the path of the directory
    """
    if not os.path.isdir(path_dir):
        raise NotADirectoryError(f"Directory not found: {path_dir}")
